...
class ActionTypes:
    ...
    MARKET_ITEM_CREATE = 'MARKET_ITEM_CREATE'
    MARKET_ITEM_UPDATE = 'MARKET_ITEM_UPDATE'
    MARKET_ITEM_DELETE = 'MARKET_ITEM_DELETE'
    MARKET_PURCHASE = 'MARKET_PURCHASE'
    MARKET_ORDER_UPDATE = 'MARKET_ORDER_UPDATE'
    MARKET_ORDER_FULFILLED = 'MARKET_ORDER_FULFILLED'
    MARKET_ORDER_CANCELLED = 'MARKET_ORDER_CANCELLED'